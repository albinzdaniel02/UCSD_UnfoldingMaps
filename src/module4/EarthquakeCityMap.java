...
public class EarthquakeCityMap extends PApplet {
	...
	private void addKey() {	
		...
		textSize(12);
		text("City", 75, 80);
		text("LandQuake", 75, 100);
		text("OceanQuake", 75, 120);
		
		fill(255);
		int factor=12;
		int x=56,y=85;
		triangle(x-factor*(0.5f), y+factor*(0.866f/3), x,y-factor*(2*0.866f/3), x+factor*(0.5f), y+factor*(0.866f/3));
		rect(50, 95, 11, 11);
		ellipse(56, 120, 13, 13);
	...
	private void printQuakes() 
	{
		...
		for (Marker cm : countryMarkers) {
			...
			for (Marker m : quakeMarkers) {
				String con = (String)m.getProperty("country");
			...
			if(qc>0)
				System.out.println(name+": "+qc);
		}
		System.out.println("OCEAN QUAKES: "+oc/countryMarkers.size());
		//        
